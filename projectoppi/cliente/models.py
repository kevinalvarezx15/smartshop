...
class Clientes(models.Model):
    ...
    celular=models.CharField(max_length=15,verbose_name='Celular',default=0)
    ...
    celularContacto=models.CharField(max_length=15,verbose_name='Celular contacto',default=0,null=True,blank=True)
